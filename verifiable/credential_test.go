...
func TestParseCredential(t *testing.T) {
	t.Run("test creation of new Verifiable Credential from JSON with valid structure", func(t *testing.T) {
		vc, err := parseTestCredential(t, []byte(v11ValidCredential), WithStrictValidation(), WithDisabledProofCheck())
...
func TestParseCredentialWithoutIssuanceDate(t *testing.T) {
	t.Run("test creation of new Verifiable Credential with disabled issuance date check", func(t *testing.T) {
		...
		vc, err := parseTestCredential(t, []byte(v11CredentialWithoutIssuanceDate), WithDisabledProofCheck(),
	...
	t.Run("'issuanceDate is required' error", func(t *testing.T) {
		_, err := parseTestCredential(t, []byte(v11CredentialWithoutIssuanceDate), WithDisabledProofCheck(),
			WithStrictValidation())
		require.Error(t, err)
	})
}

func TestParseCredentialWithoutValidFrom(t *testing.T) {
	t.Run("test creation of new Verifiable Credential with disabled validFrom check", func(t *testing.T) {
		schema := JSONSchemaLoaderV2(WithDisableRequiredField("validFrom"))

		vc, err := parseTestCredential(t, []byte(v20CredentialWithoutValidFrom), WithDisabledProofCheck(),
			WithStrictValidation(),
			WithSchema(schema))
		require.NoError(t, err)
		require.NotNil(t, vc)
	...
	t.Run("'validFrom is required' error", func(t *testing.T) {
		_, err := parseTestCredential(t, []byte(v20CredentialWithoutValidFrom), WithDisabledProofCheck(),
			WithStrictValidation())
		require.ErrorContains(t, err, "validFrom is required")
	})
}

func TestValidateVerCredContextV1(t *testing.T) {
	t.Run("test verifiable credential with a single context", func(t *testing.T) {
		...
		require.NoError(t, json.Unmarshal([]byte(v11ValidCredential), &raw))
...
func TestValidateVerCredContextV20(t *testing.T) {
	t.Run("test verifiable credential with a single context", func(t *testing.T) {
		var raw JSONObject
...
func TestValidateVerCredIssuanceDate(t *testing.T) {
	...
	t.Run("test verifiable credential with wrong format of issuance date", func(t *testing.T) {
		...
		require.NoError(t, json.Unmarshal([]byte(v11ValidCredential), &vcMap))
...
func TestCustomCredentialJsonSchemaValidator2018(t *testing.T) {
	...
	var raw JSONObject
	err := json.Unmarshal([]byte(v11ValidCredential), &raw)
	require.NoError(t, err)
...
func TestRawCredentialSerialization(t *testing.T) {
	cBytes := []byte(v11ValidCredential)
...
func Test_JWTVCToJSON(t *testing.T) {
	...
	vcSource, err := parseTestCredential(t, []byte(v11ValidCredential), WithDisabledProofCheck())
	require.NoError(t, err)
...
func TestParseCredentialFromRaw_PreserveDates(t *testing.T) {
	vcMap, err := jsonutil.ToMap(v11ValidCredential)
	require.NoError(t, err)
...
func TestParseCredentialWithDisabledProofCheck(t *testing.T) {
	...
	t.Run("ParseUnverifiedCredential() for JWT error cases", func(t *testing.T) {
		validCred, err := parseTestCredential(t, []byte(v11ValidCredential), WithDisabledProofCheck())
		require.NoError(t, err)
	...
	t.Run("ParseUnverifiedCredential() error cases", func(t *testing.T) {
		...
		require.NoError(t, json.Unmarshal([]byte(v11ValidCredential), &rawVCMap))
...
func TestCredential_ValidateCredential(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		vc, err := ParseCredential([]byte(v11ValidCredential), WithCredDisableValidation(), WithDisabledProofCheck())
		require.NoError(t, err)
		require.NotNil(t, vc)
	...
	t.Run("Invalid cred", func(t *testing.T) {
		vc, err := ParseCredential([]byte(v11CredentialWithoutIssuanceDate),
