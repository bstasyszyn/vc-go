...
var (
	...
	v11ValidCredential string //nolint:gochecknoglobals

	//go:embed testdata/v1_credential_without_issuancedate.jsonld
	v11CredentialWithoutIssuanceDate string //nolint:gochecknoglobals
)

var (
	//go:embed testdata/v2_valid_credential.jsonld
	v20ValidCredential string //nolint:gochecknoglobals

	//go:embed testdata/v2_credential_without_validfrom.jsonld
	v20CredentialWithoutValidFrom string //nolint:gochecknoglobals
)
...
func createVCWithLinkedDataProof(t *testing.T) (*Credential, *checker.ProofChecker) {
	...
	vc, err := ParseCredential([]byte(v11ValidCredential),
