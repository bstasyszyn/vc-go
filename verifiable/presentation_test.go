...
func TestV2ParsePresentation(t *testing.T) {
	...
	t.Run("creates a new Verifiable Presentation of type EnvelopedVerifiablePresentation", func(t *testing.T) {
		const pubKeyID = "did:123#issuer-key"

		t.Run("vp-ld+jwt", func(t *testing.T) {
			vcc := vccProtoV2
		...
		t.Run("vp-ld+cose", func(t *testing.T) {
			vcc := vccProtoV2
			vcc.Issuer.ID = "did:123"
